...
const loadSettings = async () => {
    ...
    if (settingsCache) {
        ...
        // Migrate default menuStyle to 2 (Interactive Buttons) as requested by user
        if (settingsCache.menuStyle === 1) {
            settingsCache.menuStyle = 2;
            updates.menuStyle = 2;
            if (settingsCache.dataValues) {
                settingsCache.dataValues.menuStyle = 2;
            }
            needsUpdate = true;
        }
