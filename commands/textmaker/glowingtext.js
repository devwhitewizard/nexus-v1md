...
module.exports = {
  ...
  async execute({ sock, jid, args, msg }) {
    try {
      ...
      const imageBuffer = await generateTextEffect('https://textpro.me/create-glowing-neon-light-text-effect-online-1061.html', text);
      await sock.sendMessage(jid, { image: imageBuffer, caption: `✨ *GLOWING TEXT EFFECT*\n\n💎 *Text:* ${text}\n🛡️ *Powered by Nexus-1MD*` }, { quoted: msg });
